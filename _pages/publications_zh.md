...
3. Liu Ziyin\*, **Kangqiao Liu**\*, Takashi Mori, and Masahito Ueda (\*equal contribution)<br />
   *Strength of Minibatch Noise in SGD*<br />
   ...
   [[arXiv:2102.05375]](https://arxiv.org/abs/2102.05375). <a href="{{ '/publications/4355_strength_of_minibatch_noise_in.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="ml_minibatch" lang="zh" %}
4. Takashi Mori, Liu Ziyin, **Kangqiao Liu**, and Masahito Ueda<br />
  *Power-law escape rate of SGD*<br />
  ...
  [[arXiv:2105.09557]](https://arxiv.org/abs/2105.09557). <a href="{{ '/publications/mori22a.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="ml_escape" lang="zh" %}
5. Jiale Yu\*, Shiyu Wang\*, **Kangqiao Liu**, Chen Zha, Yulin Wu, Fusheng Chen, Yangsen Ye, Shaowei Li, Qingling Zhu, Shaojun Guo, Haoran Qian, He-Liang Huang, Youwei Zhao, Chong Ying, Daojin Fan, Dachao Wu, Hong Su, Hui Deng, Hao Rong, Kaili Zhang, Sirui Cao, Jin Lin, Yu Xu, Cheng Guo, Na Li, Futian Liang, Yong-Heng Huo, Chao-Yang Lu, Cheng-Zhi Peng, Kae Nemoto, W. J. Munro, Xiaobo Zhu, Jian-Wei Pan, and Ming Gong<br />
  *Experimental demonstration of a Maxwell's demon quantum battery in a superconducting NISQ processor*<br />
  ...
  (IF = 2.9，中科院2区). <a href="{{ '/publications/PhysRevA.109.062614.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="quantum_battery" lang="zh" %}
6. **Kangqiao Liu** and Jie Gu<br />
  *Dynamical activity universally bounds precision of response in Markovian nonequilibrium systems*<br />
  ...
  [[arXiv:2410.20800]](https://arxiv.org/abs/2410.20800). <a href="{{ '/publications/s42005-025-01982-w.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="stoch_response" lang="zh" %}
7. **Kangqiao Liu**, Masaya Nakagawa, and Masahito Ueda<br />
  *Maxwell's demon for quantum transport*<br />
  ...
  [[arXiv:2303.08326]](https://arxiv.org/abs/2303.08326). <a href="{{ '/publications/PRA_113_022436_2026_Published_Article.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="quantum_transport" lang="zh" %}
8. **Kangqiao Liu** and Jie Gu<br />
  *Response kinetic uncertainty relation for Markovian open quantum systems*<br />
  ...
  [[arXiv:2501.04895]](https://arxiv.org/abs/2501.04895). <a href="{{ '/publications/ps1b-8l1x.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="open_rkur" lang="zh" %}
...
3. Deyou Chen, Lifang Li, Chuang Yang, and **Kangqiao Liu**<br />
  *Horizon–orbit scale competition underlying chaos bound violation for spinning particles*<br />
  [[arXiv:2609.18143]](https://arxiv.org/abs/2609.18143) (2026.09.16). <a href="{{ '/publications/2609.18143v3.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="gravity_blackbounce" lang="zh" %}
4. **Kangqiao Liu**, Jie Gu, and Deyou Chen<br />
  *Collective advantage from a minimal record in a quantum information engine*<br />
  [[arXiv:2609.24558]](https://arxiv.org/abs/2609.24558) (2026.09.21). <a href="{{ '/publications/2609.24558v1.pdf' | relative_url }}" class="btn btn--small" target="_blank" rel="noopener">PDF</a>{% include publication-feature.html id="collective_engine" lang="zh" %}
