...
* **Gravitation and black-hole physics**
  * We identified a unified **horizon–orbit scale competition** controlling chaos-bound violation for charged spinning particles in *black-bounce–Kerr–Newman spacetime*. Increasing the black-bounce deformation can drive violation by suppressing the **surface gravity** faster than the local orbital Lyapunov exponent even while the orbit becomes less unstable; at fixed background, within the parameter ranges considered, particle **total angular momentum** provides the dominant variation of the local radial instability and can drive the threshold crossing, while spin and charge shift it in a branch-dependent manner.[[arXiv:2609.18143]](https://arxiv.org/abs/2609.18143)
